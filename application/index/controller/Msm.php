...
*/
	 ...
	 */
		...
		public function sendsms($code, $phone ,$moban)
	{
		$conf = getconf('');
		if(!$phone){
			return false;
      ...
      if(!$code){
      	...
      	$smsapi = "http://api.978w.cn/yzmsms/index/"; //短信网关
      	$qianming=$conf['msm_qianming'];
      	$appkey=  $conf['msm_appkey'];
     	$sendurl = $smsapi."appkey/".$appkey."/phone/".$phone."/moban/".$moban."/app/".$qianming."/code/".$code;
